...
pub mod drop_rule {
    ...
    pub struct TagMatch {
        ...
        pub tag_name: ::protobuf::MessageField<StringMatch>,
    ...
    impl ::protobuf::Message for TagMatch {
        ...
        fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
            while let Some(tag) = is.read_raw_tag_or_eof()? {
                match tag {
                    10 => {
                        ::protobuf::rt::read_singular_message_into_field(is, &mut self.tag_name)?;
                    },
                    18 => {
        ...
        fn default_instance() -> &'static TagMatch {
            static instance: TagMatch = TagMatch {
                tag_name: ::protobuf::MessageField::none(),
    ...
    impl ::protobuf::Enum for ValueMatchOperator {
        ...
        fn from_i32(value: i32) -> ::std::option::Option<ValueMatchOperator> {
            match value {
                ...
                1 => ::std::option::Option::Some(ValueMatchOperator::GREATER),
                2 => ::std::option::Option::Some(ValueMatchOperator::LESS),
                3 => ::std::option::Option::Some(ValueMatchOperator::GREATER_OR_EQUAL),
                4 => ::std::option::Option::Some(ValueMatchOperator::LESS_OR_EQUAL),
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x1a\xa4\x01\n\x08TagMatch\x12J\n\x08tag_name\x18\x01\x20\x01(\x0b2/.pul\
    se.config.processor.v1.DropRule.StringMatchR\x07tagName\x12L\n\ttag_valu\
    e\x18\x02\x20\x01(\x0b2/.pulse.config.processor.v1.DropRule.StringMatchR\
    \x08tagValue\x1a~\n\x10SimpleValueMatch\x12\x16\n\x06target\x18\x01\x20\
    \x01(\x01R\x06target\x12R\n\x08operator\x18\x02\x20\x01(\x0e26.pulse.con\
    fig.processor.v1.DropRule.ValueMatchOperatorR\x08operator\x1a\x80\x01\n\
    \nValueMatch\x12Y\n\x0csimple_value\x18\x01\x20\x01(\x0b24.pulse.config.\
    processor.v1.DropRule.SimpleValueMatchH\0R\x0bsimpleValueB\x17\n\x10valu\
    e_match_type\x12\x03\xf8B\x01\x1a\xe7\x02\n\rDropCondition\x12R\n\x0bmet\
    ...
    ocessor.v1.DropRule.AndMatchH\0R\x08andMatchB\x15\n\x0econdition_type\
    \x12\x03\xf8B\x01\"_\n\x12ValueMatchOperator\x12\t\n\x05EQUAL\x10\0\x12\
    \x0b\n\x07GREATER\x10\x01\x12\x08\n\x04LESS\x10\x02\x12\x14\n\x10GREATER\
    _OR_EQUAL\x10\x03\x12\x11\n\rLESS_OR_EQUAL\x10\x04\"$\n\x08DropMode\x12\
    \x0b\n\x07ENABLED\x10\0\x12\x0b\n\x07TESTING\x10\x01\"G\n\nDropConfig\
    \x129\n\x05rules\x18\x01\x20\x03(\x0b2#.pulse.config.processor.v1.DropRu\
    leR\x05rules\"\xb9\x01\n\x13DropProcessorConfig\x12K\n\x0bfile_source\
    \x18\x01\x20\x01(\x0b2(.pulse.config.common.v1.FileSourceConfigH\0R\nfil\
    eSource\x12?\n\x06inline\x18\x02\x20\x01(\x0b2%.pulse.config.processor.v\
    1.DropConfigH\0R\x06inlineB\x14\n\rconfig_source\x12\x03\xf8B\x01b\x06pr\
    oto3\
";
