...
pub mod drop_rule {
    ...
    impl ValueMatch {
        ...
        pub fn is_nan(&self) -> bool {
            match self.value_match_type {
                ::std::option::Option::Some(value_match::Value_match_type::IsNan(v)) => v,
                _ => false,
            }
        }

        pub fn clear_is_nan(&mut self) {
            self.value_match_type = ::std::option::Option::None;
        }

        pub fn has_is_nan(&self) -> bool {
            match self.value_match_type {
                ::std::option::Option::Some(value_match::Value_match_type::IsNan(..)) => true,
                _ => false,
            }
        }

        // Param is passed by value, moved
        pub fn set_is_nan(&mut self, v: bool) {
            self.value_match_type = ::std::option::Option::Some(value_match::Value_match_type::IsNan(v))
        }
        ...
        pub(in super) fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
            ...
            fields.push(::protobuf::reflect::rt::v2::make_oneof_copy_has_get_set_simpler_accessors::<_, _>(
                "is_nan",
                ValueMatch::has_is_nan,
                ValueMatch::is_nan,
                ValueMatch::set_is_nan,
            ));
        ...
        fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
            while let Some(tag) = is.read_raw_tag_or_eof()? {
                match tag {
                    ...
                    16 => {
                        self.value_match_type = ::std::option::Option::Some(value_match::Value_match_type::IsNan(is.read_bool()?));
                    },
                    tag => {
                        ::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                    },
        ...
        fn compute_size(&self) -> u64 {
            ...
            if let ::std::option::Option::Some(ref v) = self.value_match_type {
                match v {
                    ...
                    &value_match::Value_match_type::IsNan(v) => {
                        my_size += 1 + 1;
                    },
                };
            }
    ...
    pub mod value_match {
        ...
        pub enum Value_match_type {
            ...
            // @@protoc_insertion_point(oneof_field:pulse.config.processor.v1.DropRule.ValueMatch.is_nan)
            IsNan(bool),
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    .ValueMatchOperatorR\x08operator\x1a\x99\x01\n\nValueMatch\x12Y\n\x0csim\
    ple_value\x18\x01\x20\x01(\x0b24.pulse.config.processor.v1.DropRule.Simp\
    leValueMatchH\0R\x0bsimpleValue\x12\x17\n\x06is_nan\x18\x02\x20\x01(\x08\
    H\0R\x05isNanB\x17\n\x10value_match_type\x12\x03\xf8B\x01\x1aD\n\x11Time\
    stampAgeMatch\x12/\n\x0fmax_age_seconds\x18\x01\x20\x01(\x04R\rmaxAgeSec\
    ondsB\x07\xfaB\x042\x02\x20\0\x1a\xa2\x04\n\rDropCondition\x12R\n\x0bmet\
    ric_name\x18\x01\x20\x01(\x0b2/.pulse.config.processor.v1.DropRule.Strin\
    gMatchH\0R\nmetricName\x12K\n\ttag_match\x18\x02\x20\x01(\x0b2,.pulse.co\
    nfig.processor.v1.DropRule.TagMatchH\0R\x08tagMatch\x12Q\n\x0bvalue_matc\
    h\x18\x03\x20\x01(\x0b2..pulse.config.processor.v1.DropRule.ValueMatchH\
    \0R\nvalueMatch\x12K\n\tand_match\x18\x04\x20\x01(\x0b2,.pulse.config.pr\
    ocessor.v1.DropRule.AndMatchH\0R\x08andMatch\x12P\n\tnot_match\x18\x05\
    \x20\x01(\x0b21.pulse.config.processor.v1.DropRule.DropConditionH\0R\x08\
    notMatch\x12g\n\x13timestamp_age_match\x18\x06\x20\x01(\x0b25.pulse.conf\
    ig.processor.v1.DropRule.TimestampAgeMatchH\0R\x11timestampAgeMatchB\x15\
    ...
    \x20\x03(\x0b2#.pulse.config.processor.v1.DropRuleR\x05rules\"\xb9\x01\n\
    \x13DropProcessorConfig\x12K\n\x0bfile_source\x18\x01\x20\x01(\x0b2(.pul\
    se.config.common.v1.FileSourceConfigH\0R\nfileSource\x12?\n\x06inline\
    \x18\x02\x20\x01(\x0b2%.pulse.config.processor.v1.DropConfigH\0R\x06inli\
