...
pub struct QueuePolicy {
    ...
    // @@protoc_insertion_point(field:pulse.config.outflow.v1.QueuePolicy.use_fifo)
    pub use_fifo: bool,
    // special fields
...
impl QueuePolicy {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "use_fifo",
            |m: &QueuePolicy| { &m.use_fifo },
            |m: &mut QueuePolicy| { &mut m.use_fifo },
        ));
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x04H\x01R\x15concurrentBatchQueues\x88\x01\x01\x12\x19\n\x08use_fifo\
    \x18\x04\x20\x01(\x08R\x07useFifoB\x12\n\x10_queue_max_bytesB\x1a\n\x18_\
    concurrent_batch_queuesb\x06proto3\
";
